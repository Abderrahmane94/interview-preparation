...
### Patrons de conception microservices
...
### Data Mesh et style d'intégration
...
### Principes de conception (SOLID & Patrons GoF)
...
### Bases de données (PL/SQL, PostgreSQL et migrations)
